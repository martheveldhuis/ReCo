...
class Evaluator:
    ...
    def evaluate(self, method):
        ...
        evaluation.to_csv(r'evaluation\x.csv')
    ...
    def print_scores(self):
        ...
        filenames = [r'eval_dice', r'eval_dice_genetic', r'eval_whatif',
                     r'eval_reco_no_f', r'eval_reco',
                     r'eval_reco_par_no_f', r'eval_reco_par']
    ...
    def plot_boxplot(self): 
        ...
        filenames = [r'evaluation\eval_dice.csv',
                     r'evaluation\eval_dice_genetic.csv',
                     r'evaluation\eval_whatif.csv',
                     r'evaluation\eval_reco_par.csv']
