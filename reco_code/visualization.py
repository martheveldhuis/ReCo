...
class Visualization:
    ...
    def __init__(self, data_point, data_point_scaled, prediction, shap_values):
        ...
        self.plot_shap()
        self.plot_profile()
        self.fig.savefig(r'results\_' + self.data_point.name + '.png', 
    ...
    def plot_counterfactual(self, counterfactual, counterfactual_scaled, counterfactual_pred, changes, tol=False):
        ...
        if(tol):
            self.fig.savefig(r'results\_' + data_point.name + '_' + counterfactual.name + '_tol.png', 
                    facecolor=self.fig.get_facecolor(), bbox_inches='tight')
        else:
            self.fig.savefig(r'results\_' + data_point.name + '_' + counterfactual.name + '.png', 
                    facecolor=self.fig.get_facecolor(), bbox_inches='tight')
