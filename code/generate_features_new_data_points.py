...
data = {}
for files in glob.glob(r"D:\Documenten\TUdelft\thesis\mep_veldhuis\data\new\*"):
    file = open(files, "r")
    line1 = file.readline()
...
with open(r"D:\Documenten\TUdelft\thesis\mep_veldhuis\data\Features_new_19.txt", "w") as outfile:
